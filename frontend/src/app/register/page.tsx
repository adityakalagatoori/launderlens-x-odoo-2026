...
export default function RegisterPage() {
  return (
    <main className="flex min-h-screen flex-col items-center justify-center p-6 relative z-10 overflow-hidden">
      <div className="w-full max-w-2xl flex flex-col items-center animate-fade-in-up">
        ...
        <div className="mb-10 flex flex-col items-center gap-3">
          ...
          <p className="text-[#1A1A1A]/70 font-medium text-sm tracking-wide uppercase">Join the Journey</p>
        </div>
